(function () {
    ...
    var options = {
        ...
        xaxis: {
            categories: ['1. Presencial', '2. EAD', '3. Pós Digital', '4. Pós ao Vivo'],
            labels: {
                show: true,
                style: {
                    colors: "#8c9097",
    ...
    var chart2 = new ApexCharts(document.querySelector("#bar-basic2"), options2);
    chart2.render();

    var options3 = {
        series: [{
            data: [100, 600, 200, 500]
        }],
        chart: {
            type: 'bar',
            height: 180
    ...
    var chart3 = new ApexCharts(document.querySelector("#bar-basic3"), options3);
    chart3.render();
